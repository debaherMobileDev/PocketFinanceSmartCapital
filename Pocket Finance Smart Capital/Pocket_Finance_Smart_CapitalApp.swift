//
//  Pocket_Finance_Smart_CapitalApp.swift
...
@main
struct Pocket_Finance_Smart_CapitalApp: App {
    var body: some Scene {
        WindowGroup {
            LaunchCheckView()
        }
...
// Launch Check View - проверяет сервер при запуске
        ...
        ZStack {
            ...
            if isFetched == false {
                ...
                if isBlock == true {
                    ...
                    // Показываем обычное приложение Pocket Finance
                    ContentView()
